...
- [ ] S0 Inspect A1; add SQLite init/table/seed-if-empty; restart 3x -> exactly 3; commit `Stage 0: create SQLite database`
- [ ] S1 Replace GET storage with parameterized SELECTs; keep 200/404 contract; commit `Stage 1: database read endpoints`
- [ ] S2 Replace POST storage with INSERT; SQLite ID; persist after restart; keep 400/201; commit `Stage 2: insert into database`
...
- [ ] PUSH updated same public repo; verify honest stage commits
