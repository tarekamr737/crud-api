...
- [x] S3 Add POST; next ID; `done=false`; 201; invalid title → 400; commit `Stage 3: create with validation`
...
- [x] FINAL Re-run curl CRUD flow; verify `200/201/204/400/404`; remove dead/out-of-scope code
