...
- [ ] S1 Add required `/` metadata + `/health`; verify 200; commit `Stage 1: root and health endpoints`
- [ ] S2 Seed 3 tasks; add GET list/single + 404 JSON; commit `Stage 2: read endpoints with 404`
